...
main_system = mm.MKMultiMaterialSystem(base_model = model1, delta_time = 1e-7,\
                                       delta_pos = voxel_L, time_step_scaling = 1, padding=(1, 0.2, 0.2))
