...
import MKMultiMaterialSystem_v2 as mm
reload(mm)
...
main_system = mm.MKMultiMaterialSystem(base_model = model1, delta_pos=(0.1, 0.1, 0.1), time_step_scaling = 4.0, padding=(1, 0.2, 0.2))
...
data = main_system.runSimulation(iterationTime=100000, initU=u_init, figureID=777001, ySection= 15, applyNeumann=False)
