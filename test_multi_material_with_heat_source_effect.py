...
model1 = mm.MKModel(model_id= 1, model_size=(20,50,50), D = 0.5e-0, initial_condition = 35)
...
main_system = mm.MKMultiMaterialSystem(base_model = model1, delta_time = 1e-4,\
                                       delta_pos = 0.1/mfactor, time_step_scaling = 1, padding=(1, 0.2, 0.2))
...
mm.plot2DImage(2, main_system.main_model[:,10,:], xAxisLabel= 'X (mm)', yAxisLabel= 'Z (mm)' )
mm.plot2DImage(21, np.nan_to_num(u_init[:,10,:]), xAxisLabel= 'X (mm)', yAxisLabel= 'Z (mm)')
...
data, mid_temp = main_system.runSimulation_v2(iterationTime=10000, initU=u_init, figureID=401,\
                                    ySection= 25, applyDiri=True, applyNeumann=False, \
